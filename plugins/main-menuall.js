...
break;
        ...
        case 'botmenu':
          ...
          ᴍʏᴛ ᴢɪᴍ ᴄʏʙᴇʀ ᴍᴅ ᴍᴇɴᴜ ʜᴇʀᴇ
          ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍʀ sʜᴇʟʟᴀʜ
          
┊ ಢ‸ಢ  ${usedPrefix}𝙋𝙞𝙣𝙜 ✧
┊ ಢ‸ಢ  ${usedPrefix}𝙐𝙥𝙩𝙞𝙢𝙚 ✧
┊ ಢ‸ಢ  ${usedPrefix}𝘽𝙤𝙩/𝙋𝙧𝙞𝙣𝙘𝙚 ✧
┊ ಢ‸ಢ  ${usedPrefix}𝙊𝙬𝙣𝙚𝙧 ✧
┊ ಢ‸ಢ  ${usedPrefix}𝙄𝙣𝙛𝙤𝙗𝙤𝙩 ✧
┊ ಢ‸ಢ  ${usedPrefix}𝙂𝙧𝙤𝙪𝙥𝙨 ✧
┊ ಢ‸ಢ  ${usedPrefix}𝘽𝙡𝙤𝙘𝙠𝙡𝙞𝙨𝙩 ✧
┊ ಢ‸ಢ  ${usedPrefix}𝙇𝙞𝙨𝙩𝙥𝙧𝙚𝙢 ✧
┊ ಢ‸ಢ  ${usedPrefix}𝙂𝙜𝙥 ✧
┊ ಢ‸ಢ  ${usedPrefix}𝙂𝙥𝙥𝙧𝙞𝙣𝙘𝙚 ✧
┊ ಢ‸ಢ  ${usedPrefix}𝙈𝙚𝙣𝙪/𝙃𝙚𝙡𝙥/𝙃 ✧
└───── •l ꙰ᕯl ꙰ᕯl ꙰ᕯl ꙰ᕯ• ─────┘`; // Your bot menu message here
          break;
        case 'ownermenu':
          lkr = `┌────•✧𝙊𝙒𝙉𝙀𝙍 𝘾𝙊𝙈𝙈𝘼𝙉𝘿𝙎✧•────┐
