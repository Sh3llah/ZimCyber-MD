  ...
  download: async (link, format, type = 'video') => {
    ...
    try {
      ...
      while (retries < maxRetries) {
        ...
        if (data.e || data.i === "invalid") {
          return {
            status: false,
            code: 400,
            error: "The video doesn't exist. Maybe it was deleted or restricted by YouTube.By mr "
          };
        }
      ...
      return {
        status: false,
        code: 500,
        error: "I'm exhausted... Tried several times, but it still doesn't work. So I'll leave it for now. Goodbye! 😂and let you code legecy continuous the journey"
      };
